...
const KNOWLEDGE_BASE = {
  platform: {
    ...
    techStack: {
      ...
      backend:
        'Node.js, Express, Firebase (Authentication, Firestore Database, Hosting), OpenRouter API',
      hosting: 'Vercel',
    },
    brandProtection:
  ...
  features: {
    ...
    resourceLibrary:
      'Access curated roadmaps, guides, and tutorials for MERN/React stack, Python for AI, profile setup, and developer mindset.',
    wikiKnowledgeBase:
      'Explore guides, documentation, platform tutorials, and community articles.',
    userProfiles:
      'Showcase skills, achievements, linked GitHub repositories, experience points (XP), and badges.',
    openSourceDashboard:
      'Contribute to projects and grow through real-world experience. Main dashboard: /opensource',
    xpSystem:
      'Experience Points (XP) gamify the learning journey. Earn XP through daily logins, completing projects, and open source contributions (merged PRs). Earned XP counts towards the leaderboard ranking.',
  },
  roles: {
    cityLeads: {
      title: 'City Leads',
      description:
        'Local community ambassadors bridging DevPath and regional developers.',
      responsibilities: [
      ...
      selection:
        'Selected quarterly from active contributors who exhibit strong leadership qualities and passion.',
    },
    technicalHeads: {
      title: 'Technical Heads',
      description:
        'Subject matter experts ensuring the quality of technical content and projects.',
      responsibilities: [
  ...
  repositories: [
    ...
    },
    {
      ...
      longDescription:
        'A powerful CLI tool to help developers navigate learning paths and access resources from the terminal.',
      language: 'JavaScript',
  ...
  events: {
    hackFiesta: {
      name: 'HackFiesta',
      description:
        "DevPath's flagship annual 48-hour hackathon bringing developers together to solve real-world problems.",
      details: [
...
const FALLBACK_RESPONSES = {
  outOfScope:
    "I'm sorry, I can only help you with questions related to the DevPath platform, its learning paths, community events, and open-source contributions. For other technical or general topics, feel free to ask in our WhatsApp Community or seek external resources!",
  unknownFeature:
    "I don't have information about that specific feature or detail. Please feel free to check our official Wiki, ask in the WhatsApp Community, or contact us at devpathind.community@gmail.com.",
};
