      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              A complete, free, and industry-recognized curriculum designed to
              take you from zero to hero. No paid courses, no scattered
              tutorials.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-24">
          ...
          <motion.div
            ...
            className="group relative bg-gradient-to-b from-card to-transparent border border-border dark:border-[hsl(var(--border)/0.3)] rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 shadow-lg shadow-primary/5 dark:shadow-2xl dark:shadow-black/50"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-6">
                Build beautiful, interactive user interfaces. Master the art of
                crafting responsive web experiences.
              </p>
              <ul className="space-y-3 text-sm text-[hsl(var(--foreground)/0.8)]">
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-blue-500" /> HTML5 &
                  Semantic Web
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-blue-500" /> Modern
                  CSS & Tailwind
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-blue-500" /> React &
                  Next.js
                </li>
              </ul>
            </div>
          ...
          <motion.div
            ...
            className="group relative bg-gradient-to-b from-card to-transparent border border-border dark:border-[hsl(var(--border)/0.3)] rounded-3xl p-8 hover:border-purple-500/30 transition-all duration-300 shadow-lg shadow-purple-500/5 dark:shadow-2xl dark:shadow-black/50"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-6">
                Power your applications with robust server-side logic,
                databases, and APIs.
              </p>
              <ul className="space-y-3 text-sm text-[hsl(var(--foreground)/0.8)]">
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-purple-500" /> Node.js
                  & Express
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-purple-500" /> Python
                  & Django/FastAPI
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-purple-500" /> SQL &
                  NoSQL Databases
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-purple-500" /> API
                  Design & Security
                </li>
              </ul>
            </div>
          ...
          <motion.div
            ...
            className="group relative bg-gradient-to-b from-card to-transparent border border-border dark:border-[hsl(var(--border)/0.3)] rounded-3xl p-8 hover:border-green-500/30 transition-all duration-300 shadow-lg shadow-green-500/5 dark:shadow-2xl dark:shadow-black/50"
          >
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-3 text-sm text-[hsl(var(--foreground)/0.8)]">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-green-500" /> System
                  Architecture
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-green-500" />{' '}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-3xl md:text-4xl font-bold">Launch Timeline</h2>
            <div className="relative border-l border-[hsl(var(--muted-foreground)/0.3)] pl-8 space-y-10">
              <div className="relative">
                ...
                <p className="text-muted-foreground">
                  We kick off with the HTML Masterclass, followed immediately by
                  CSS Styling & Layouts. The perfect start for beginners.
                </p>
              </div>
              <div className="relative">
                ...
                <p className="text-muted-foreground">
                  Python Programming and JavaScript Essentials. Learn to think
                  like a programmer.
                </p>
              </div>
              <div className="relative">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-background border border-border dark:border-[hsl(var(--border)/0.3)] rounded-3xl p-8 md:p-10 shadow-xl shadow-black/5 dark:shadow-2xl dark:shadow-black/50"
          >
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Earn free, verified certificates upon completion to showcase
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Don&apos;t just watch tutorials. Build real-world
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Quality education should be accessible to everyone. No
                    hidden fees, ever.
                  </p>
                </div>
              </li>
