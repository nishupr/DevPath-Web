...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; ring: string }> = {
  Frontend:  { bg: "bg-blue-500/10",   text: "text-blue-400",   ring: "ring-blue-500/20" },
  Backend:   { bg: "bg-green-500/10",  text: "text-green-400",  ring: "ring-green-500/20" },
  Database:  { bg: "bg-yellow-500/10", text: "text-yellow-400", ring: "ring-yellow-500/20" },
  DevOps:    { bg: "bg-pink-500/10",   text: "text-pink-400",   ring: "ring-pink-500/20" },
  Mobile:    { bg: "bg-purple-500/10", text: "text-purple-400", ring: "ring-purple-500/20" },
  default:   { bg: "bg-sky-500/10",    text: "text-sky-400",    ring: "ring-sky-500/20" },
};
  ...
  return (
    <section>
      <div className="flex items-center gap-2 mb-5">
        ...
        <h2 className="text-xl font-bold tracking-tight">Verified Tech Stack</h2>
      ...
      <div className="space-y-5">
        {Object.entries(grouped).map(([category, catSkills]) => {
          ...
          return (
            <div key={category}>
              <h3 className={`text-xs font-semibold uppercase tracking-widest mb-2 ${style.text}`}>
                {category}
              </h3>
