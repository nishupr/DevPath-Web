  ...
  return (
    ...
    >
      ...
      <div style={{ borderBottom: "2px solid #111", paddingBottom: 12, marginBottom: 16 }}>
        ...
        {/* Social links inline */}
        <div style={{ marginTop: 6, display: "flex", gap: 16, fontSize: "9pt", color: "#555" }}>
          ...
          {resume.projects.map((p) => (
            <div key={p.name} style={{ marginBottom: 12 }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                {p.url && (
                  <span style={{ fontSize: "9pt", color: "#555" }}>{p.url}</span>
                )}
              </div>
              <p style={{ margin: "2px 0 0", color: "#444" }}>{p.description}</p>
              {p.highlights.length > 0 && (
                <p style={{ margin: "2px 0 0", color: "#666", fontSize: "9.5pt" }}>
      ...
      {/* DevPath branding */}
      <p style={{ marginTop: 24, fontSize: "8pt", color: "#aaa", textAlign: "center" }}>
